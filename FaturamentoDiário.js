...
.filter(entry => entry.valor > mediaMensal)
.length;

console.log ("Menor valor de faturamento:", menorValor.toFixed(2));
console.log ("Maior valor de faturameto: ", maiorValor.toFixed(2));
console.log("Numero de dias com faturamento acima da media: ", diasAcimaDaMedia);